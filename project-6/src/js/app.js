App = {
  ...
  addFarmer: function (event) {
    event.preventDefault();
    var address = $("#farmerID").val();
    App.contracts.SupplyChain.deployed()
      .then(function (instance) {
        return instance.addFarmer(address, { from: App.metamaskAccountID });
      })
      .then(function (result) {
        console.log("Added farmer " + address);
      })
      .catch(function (err) {
        console.log(err.message);
      });
  ...
  addDistributor: function (event) {
    event.preventDefault();
    var address = $("#distributorID").val();
    App.contracts.SupplyChain.deployed()
      .then(function (instance) {
        return instance.addDistributor(address, {
          from: App.metamaskAccountID,
        });
      })
      .then(function (result) {
  ...
  fetchItemBufferTwo: function () {
    App.contracts.SupplyChain.deployed()
      ...
      .then(function (result) {
        ...
        console.log("State ", result.itemState.toNumber());
      })
      .catch(function (err) {
        console.log(err.message);
      });
