...
contract("SupplyChain", function (accounts) {
  ...
  it("Testing smart contract function harvestItem() that allows a farmer to harvest coffee", async () => {
    ...
    await supplyChain.harvestItem(
      ...
      originFarmLongitude,
      productNotes,
      { from: originFarmerID } //call as a farmer
    );
  ...
  it("Testing smart contract function processItem() that allows a farmer to process coffee", async () => {
    ...
    await supplyChain.processItem(upc, { from: originFarmerID }); //call as a farmer
  ...
  it("Testing smart contract function packItem() that allows a farmer to pack coffee", async () => {
    ...
    // Mark an item as Processed by calling function processItem()
    await supplyChain.packItem(upc, { from: originFarmerID }); //call as a farmer
    ...
    assert.equal(resultBufferTwo[5], 2, "Error: Invalid item State"); //Packed
    assert.equal(eventEmitted, true, "Invalid event emitted");
  });
  ...
  it("Testing smart contract function sellItem() that allows a farmer to sell coffee", async () => {
    ...
    await supplyChain.sellItem(upc, productPrice, { from: originFarmerID }); //call as a farmer
    ...
    assert.equal(resultBufferTwo[5], 3, "Error: Invalid item State"); //ForSale
    assert.equal(eventEmitted, true, "Invalid event emitted");
  });
  ...
  it("Testing smart contract function buyItem() that allows a distributor to buy coffee", async () => {
    ...
    await supplyChain.buyItem(
      upc,
      { from: distributorID, value: web3.utils.toWei("10", "ether") } //call as a distributor
    );
  ...
  it("Testing smart contract function shipItem() that allows a distributor to ship coffee", async () => {
    ...
    await supplyChain.shipItem(
      upc,
      { from: distributorID } //call as a distributor
    );
  ...
  it("Testing smart contract function receiveItem() that allows a retailer to mark coffee received", async () => {
    ...
    await supplyChain.receiveItem(
      upc,
      { from: retailerID, value: web3.utils.toWei("4", "ether") } //call as a retailer
    );
  ...
  it("Testing smart contract function purchaseItem() that allows a consumer to purchase coffee", async () => {
    ...
    await supplyChain.purchaseItem(
      upc,
      { from: consumerID, value: web3.utils.toWei("10", "ether") } //call as a consumer
    );
